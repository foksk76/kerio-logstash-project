...
1. Confirm the next rerun of the GitHub Actions CI workflow stays green after switching the smoke-test readiness gate from a TCP connect probe to the explicit `Starting tcp input listener` Logstash log message.
