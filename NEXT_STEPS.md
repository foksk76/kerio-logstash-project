...
1. Monitor the rerun of the new GitHub Actions CI workflow after the smoke-test JSON-body fix and tighten any flaky timing only if runner behavior still proves inconsistent.
